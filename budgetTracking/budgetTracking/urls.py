...
urlpatterns = [
    ...
    path('gestion/export/csv/', budgetTrackingViews.export_activite_csv, name='export_activite_csv'),
    path('gestion/export/excel/', budgetTrackingViews.export_activite_excel, name='export_activite_excel'),
